...
export function renderOrderSummary(){
    ...
    js-cart-item-container-${matchingProduct.id}">
      ...
      <div class="cart-item-details-grid">
        ...
        <div class="cart-item-details">
          <div class="product-name js-product-name js-product-name-${matchingProduct.id}">
  ...
  link.addEventListener('click',() => {
      ...
      const newCartInput= document.querySelector(`.js-quantity-input-${productId}`);
      const newCartQuantity= Number(newCartInput.value);
